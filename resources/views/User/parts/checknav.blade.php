...
*/
$catgs = \App\Models\Category::latest()
    ->where('status', '1')
    ->orderBy('lineup')
    ->get();
...
<header id="header" class="header header-sticky header-sticky-smart disable-transition-all z-index-5">
	...
	<div class="topbar bg-section-10">
		<div class="container-xxl container">
			<p class="mb-0 text-body-emphasis text-center p-4 fs-15px fw-bold ls-1 text-uppercase">
		...
		<div class="container-xxl container d-none d-xl-block">
			<div class="pt-8 d-flex">
                ...
                <a href="{{ url('/') }}" class="navbar-brand px-8 py-4 mx-auto">
                	<img class="light-mode-img" src="{{ asset('assets/images/others/logo.png') }}" width="179" height="26" alt="Femi9">
                	<img class="dark-mode-img" src="{{ asset('assets/images/others/logo.png') }}" width="179" height="26" alt="Femi9">
                </a>
				...
				<div class="icons-actions d-flex justify-content-end w-xl-50 fs-28px text-body-emphasis">
                    <div class="px-5 d-none d-xl-inline-block">
                    	@if (isset(Auth::user()->name))
                            	<a class="lh-1 color-inherit text-decoration-none" href="{{ route('user.profile') }}">
                    ...
                    <div class="px-5 d-none d-xl-inline-block">
                    	<a class="position-relative lh-1 color-inherit text-decoration-none" href="{{ url('/wishlist') }}">
                    ...
                    <div class="px-5 d-none d-xl-inline-block">
                    	<a class="position-relative lh-1 color-inherit text-decoration-none"  data-bs-toggle="offcanvas"
                    	   ...
                    	   aria-expanded="false">
                    		...
                    		<span id="cartCount" class="badge bg-dark text-white position-absolute top-0 start-100 translate-middle mt-4 rounded-circle fs-13px p-0 square" style="--square-size: 18px">{{ $totcart }}</span>
                    	</a>
                    </div>
				</div>
			</div>
                ...
                <div class="icons-actions d-flex justify-content-end w-xl-50 fs-28px text-body-emphasis w-72px">
                    ...
                    <div class="color-modes position-relative ps-5">
                        <a class="position-relative lh-1 color-inherit text-decoration-none" href="#" data-bs-toggle="offcanvas"
                            data-bs-target="#shoppingCart" aria-controls="shoppingCart" aria-expanded="false">
                            	<svg class="icon icon-star-light">
                            		<use xlink:href="#icon-shopping-bag-open-light"></use>
                        		</svg>
                            	<span id="cartCount" class="badge bg-dark text-white position-absolute top-0 start-100 translate-middle mt-4 rounded-circle fs-13px p-0 square" style="--square-size: 18px">{{ $totcart }}</span>
		...
		<li>
			<button type="button" class="dropdown-item d-flex align-items-center" data-bs-theme-value="auto" aria-pressed="false">
				...
				<div class="w-100 d-none d-xl-flex align-items-center justify-content-center">
					<ul class="navbar-nav">
					    <li class="nav-item transition-all-xl-1 py-xl-7 py-0 me-xxl-12 me-xl-10 dropdown dropdown-hover dropdown-fullwidth">
		                    <a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 fw-semibold ls-1 fs-6 fs-xl-15px text-body-emphasis" href="{{ url('/') }}"  id="menu-item-home" aria-haspopup="true" aria-expanded="false">Home</a>
		                </li>
		                <li class="nav-item transition-all-xl-1 py-xl-7 py-0 me-xxl-12 me-xl-10 dropdown dropdown-hover dropdown-fullwidth">
		                    <a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 fw-semibold ls-1 fs-6 fs-xl-15px text-body-emphasis" href="{{ url('/shop') }}" id="menu-item-home" aria-haspopup="true" aria-expanded="false">Shop</a>
		                </li>
		                <li class="nav-item transition-all-xl-1 py-xl-7 py-0 me-xxl-12 me-xl-10 dropdown dropdown-hover dropdown-fullwidth">
		                    <a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 fw-semibold ls-1 fs-6 fs-xl-15px text-body-emphasis" href="{{ url('/blog') }}" id="menu-item-home" aria-haspopup="true" aria-expanded="false">Blog</a>
		                </li>
		                <li class="nav-item transition-all-xl-1 py-xl-7 py-0 me-xxl-12 me-xl-10 dropdown dropdown-hover dropdown-fullwidth">
		                    <a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 fw-semibold ls-1 fs-6 fs-xl-15px text-body-emphasis" href="{{ url('/about') }}"  id="menu-item-home" aria-haspopup="true" aria-expanded="false">About</a>
		                </li>
		                <li class="nav-item transition-all-xl-1 py-xl-7 py-0 me-xxl-12 me-xl-10 dropdown dropdown-hover dropdown-fullwidth">
		                    <a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 fw-semibold ls-1 fs-6 fs-xl-15px text-body-emphasis" href="{{ url('/contact-us') }}"  id="menu-item-home" aria-haspopup="true" aria-expanded="false">Contact</a>
		                </li>
					</ul>
				</div>
			</div>
...
<div id="shoppingCart" data-bs-scroll="false" class="offcanvas offcanvas-end">
	...
	<div class="offcanvas-body me-xl-auto pt-0 mb-2 mb-xl-0">
		<form class="border-bottom table-responsive-md shopping-cart pb-8 pb-lg-10" id="cartbody">
			
		</form>
	</div>
	<div class="offcanvas-footer flex-wrap">
		<div class="d-flex align-items-center justify-content-between w-100 mb-5">
			<span class="text-body-emphasis">Total price: Rs.</span>
			<span id="addcarttotprice" class="cart-total fw-bold text-body-emphasis"></span>
		</div>
		@if (isset(Auth::user()->name))
		<a href="{{ url('/checkout') }}" class="btn btn-dark w-100 mb-7" title="Check Out">Checkout</a>
		@else
		<a class="btn btn-dark w-100 mb-7" title="Check Out"  href="#" data-bs-toggle="modal" data-bs-target="#signInModal">Login to Checkout</a>
		@endif
		<!--<a href="{{ url('/cart') }}" class="btn btn-outline-dark w-100" title="View shopping cart">View shopping cart</a>-->
	</div>
</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body px-sm-13 px-8">
				...
				<form method="post" id="cusloginform" autocomplete="off">
					@csrf
                    <input id="email" type="email"  name="email" class="form-control mb-5" placeholder="Your email" required>
					...
					<div class="d-flex align-items-center justify-content-between mt-8 mb-7">
						<div class="custom-control d-flex form-check">
							<input name="remember" {{ old('remember') ? 'checked' : '' }} name="remember-password" id="type-2" type="checkbox" class="form-check-input rounded-0 me-3" id="staySignedIn">
							<label class="custom-control-label text-body" for="type-2">{{ __('Remember Me') }}</label>
						</div>
					</div>
					<button type="submit" class="btn btn-dark btn-hover-bg-primary btn-hover-border-primary w-100">{{ __('Login') }}</button>
				</form>
			</div>
			<div class="modal-footer px-13 pt-0 pb-12 border-0">
				...
				<div class="d-flex w-100">
					<a type="submit" href="{{ route('user.login.facebook') }}" class="btn btn-outline-secondary w-100 border-2x me-5 btn-hover-bg-primary btn-hover-border-primary"><i class="fab fa-facebook-f me-4" style="color: #2E58B2"></i>Facebook</a>
					<a type="submit" href="{{ route('user.login.google') }}"class="btn btn-outline-secondary w-100 border-2x mt-0 btn-hover-bg-primary btn-hover-border-primary"><i class="fab fa-google me-4" style="color: #DD4B39"></i>Google</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body px-sm-13 px-8">
				...
				<form method="post"  id="cussignupform" autocomplete="off" >
					...
					<input id="username" type="text" name="username" value="" class="form-control border-1 mb-5" placeholder="Username *" required>
					<input id="remail" type="email" name="email" value="" class="form-control border-1 mb-5" placeholder="Your email *" required>
				
					<input id="rpassword" type="password" name="password" value="" class="form-control border-1" placeholder="Password *" required>
				
					<div class="d-flex align-items-center mt-8 mb-7">
						<div class="form-check">
							<input name="agree-policy-terms" type="checkbox" class="form-check-input rounded-0 me-3" id="agreePolicyTerm" required>
							<label class="custom-control-label text-body" for="agreePolicyTerm">Yes, I agree with Femi9 <a href="#" class="text-black">Privacy Policy</a> and  <a href="#" class="text-black">Terms of Use</a></label>
						</div>
					</div>
					<button type="submit" id="signup-btn" class="btn btn-dark btn-hover-bg-primary btn-hover-border-primary w-100">Sign Up</button>
				</form>
			</div>
			<div class="modal-footer px-13 pt-0 pb-12 border-0">
				<div class="border-bottom w-100"></div>
					...
					<div class="col-md-6 pe-13">
						<div class="position-relative">
                        	...
                        	<div id="slider" class="slick-slider slick-slider-arrow-inside slick-slider-dots-inside slick-slider-dots-light g-0" data-slick-options='{&#34;arrows&#34;:false,&#34;asNavFor&#34;:&#34;#slider-thumb&#34;,&#34;dots&#34;:false,&#34;slidesToShow&#34;:1}'>
                        			<a href="./assets/images/shop/product-gallery-05.jpg" data-gallery="gallery1"><img src="#" data-src="./assets/images/shop/product-gallery-05.jpg" class="h-auto lazy-image" width="540" height="720" alt=""></a>
                        			<a href="./assets/images/shop/product-gallery-06.jpg" data-gallery="gallery1"><img src="#" data-src="./assets/images/shop/product-gallery-06.jpg" class="h-auto lazy-image" width="540" height="720" alt=""></a>
                        			<a href="./assets/images/shop/product-gallery-07.jpg" data-gallery="gallery1"><img src="#" data-src="./assets/images/shop/product-gallery-07.jpg" class="h-auto lazy-image" width="540" height="720" alt=""></a>
                        			<a href="./assets/images/shop/product-gallery-08.jpg" data-gallery="gallery1"><img src="#" data-src="./assets/images/shop/product-gallery-08.jpg" class="h-auto lazy-image" width="540" height="720" alt=""></a>
                        	</div>
                        </div>
                        <div class="mt-6">
...
<div class="navbar">
	<div id="offCanvasNavBar" class="offcanvas offcanvas-start" style="--bs-offcanvas-width: 310px">
		<div class="offcanvas-header bg-body-tertiary">
	        <h3 class="offcanvas-title text-uppercase">Femi9</h3>
...
<div class="position-fixed bottom-0 end-0 p-10" style="z-index:99">
    <a href="#"
...
<script>
        ...
        function showcart() {
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res == '') {
                        $('#cartbody').append("<p class='fw-500 text-body-emphasis'>Empty Cart !</p>");
                    } else {
                        $('#cartbody').append(res);
                        totpricelist();
                    }
