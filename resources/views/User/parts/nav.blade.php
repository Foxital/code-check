		...
		<div class="container-xxl container d-none d-xl-block">
			<div class="pt-8 d-flex">
                ...
                <a href="{{ url('/') }}" class="navbar-brand px-8 py-4 mx-auto">
                	<img class="light-mode-img" src="{{ asset('assets/images/others/logo.png') }}" width="106" height="37" alt="Femi9">
                	<img class="dark-mode-img" src="{{ asset('assets/images/others/logo.png') }}" width="106" height="37" alt="Femi9">
                </a>
