                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">{{ isset($data->id)?'Update':'Create' }} Offer</h6>
                            </div>
                            <div class="card-body">
                                <form id="adminuser" action="/admin/offers{{ isset($data->id)?'/'.$data->id:'' }}" method="POST"
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="product_id" id="product_id" required>
                                                          <option selected value="{{ $data->Prod['id'] }}">{{ $data->Prod['name'] }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="offer_type" class="form-control" required>
                                                            ...
                                                            <option {{ isset($data->offer_type)&&$data->offer_type=='0'?'selected':'' }} value="2">Rs</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control @error('validity_from') is-invalid @enderror" name="validity_from" value="{{ old('validity_from', $data->validity_from ?? '') }}" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Validity To</label>
                                                        <input type="date" class="form-control @error('validity_to') is-invalid @enderror" name="validity_to" value="{{ old('validity_to', $data->validity_to ?? '') }}" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="text-right pt-md-4 mt-2">
                                                        ...
                                                        <a style="width:100px;" href="{{ url('/admin/offers') }}"
