                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">{{ isset($data->id)?'Update':'Create' }} SubCategory</h6>
                            </div>
                            <div class="card-body">
                                <form id="adminuser" action="/admin/sub-categorys{{ isset($data->id)?'/'.$data->id:'' }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group setimage_pv text-center" style="{{ empty($data->image)?'display:none;':'' }}" id="setimage_pv_0">
                                                ...
                                                <img src="{{ asset('uploads/Category/'.$data->image) }}" id="img_setimage_pv_0" class="img-fluid"
                                                    style="margin:auto;" />
                                                <br /><br />
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="category_id" class="form-control" required>
                                                            ...
                                                            @foreach ($catgs as $catg)
                                                                <option {{ isset($data->category_id)&&$data->category_id==$catg->id?'selected':'' }} value="{{ $catg->id }}">{{ $catg->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="text-right pt-md-4 mt-2">
                                                        ...
                                                        <a style="width:100px;" href="{{ url('/admin/sub-categorys') }}"
