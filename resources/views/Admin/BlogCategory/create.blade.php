                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">{{ isset($data->id)?'Update':'Create' }} Blog Category</h6>
                            </div>
                            <div class="card-body">
                                <form id="adminuser" action="/admin/blog-categorys{{ isset($data->id)?'/'.$data->id:'' }}" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="text-right pt-md-4 mt-2">
                                                        ...
                                                        <a style="width:100px;" href="{{ url('/admin/blog-categorys') }}"
