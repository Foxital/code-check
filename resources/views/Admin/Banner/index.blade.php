            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-2">
                        <div class="row">
                            <div class="col-md-10">
                                <h6 class="m-0 mt-2 font-weight-bold text-primary">Banner List</h6>
                            </div>
                            <div class="col-md-2 text-right">
                                <a href="{{ url('admin/banners/create') }}" class="btn btn-primary">Create Banner</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                ...
                columnDefs:[
                    {
                        ...
                        render:function(image){
                            if(image!=''&&image!=null){
                                var url = "{{ asset('uploads/Banner/') }}"+"/"+image;
                    ...
                    },
                    {
                        ...
                        render:function(image1){
                            if(image1!=''&&image1!=null){
                                var url = "{{ asset('uploads/Banner/') }}"+"/"+image1;
                                return '<img src="'+url+'" width="120px" />';
                            }else{
                                return '';
                            }
