                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">{{ isset($data->id)?'Update':'Create' }} Users</h6>
                            </div>
                            <div class="card-body">
                                <form id="adminuser" action="/admin/users{{ isset($data->id)?'/'.$data->id:'' }}" method="POST"
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="role_type" class="form-control" required>
                                                            ...
                                                            <option {{ isset($data->role_type)&&$data->role_type=='1'?'selected':'' }} value="1">Admin</option>
                                                            <option {{ isset($data->role_type)&&$data->role_type=='2'?'selected':'' }} value="2">Staff</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="text-right mt-2">
                                                        ...
                                                        <a style="width:100px;" href="{{ url('/admin/users') }}"
