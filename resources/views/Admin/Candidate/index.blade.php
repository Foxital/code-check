            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-2">
                        <div class="row">
                            <div class="col-md-10">
                                <h6 class="m-0 mt-2 font-weight-bold text-primary">candidates List</h6>
                            </div>
                            <div class="col-md-2 text-right">
                                <a href="{{ url('/admin/candidates/create') }}" class="btn btn-primary">Create candidates</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
