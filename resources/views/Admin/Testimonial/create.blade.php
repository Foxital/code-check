...
@section('content')
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">{{ isset($data->id)?'Update':'Create' }} Testimonials</h6>
                            </div>
                            <div class="card-body">
                                <form id="adminuser" action="/admin/testimonials{{ isset($data->id)?'/'.$data->id:'' }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group setimage_pv text-center" style="{{ empty($data->image)?'display:none;':'' }}" id="setimage_pv_0">
                                                ...
                                                <img src="{{ asset('uploads/Testimonial/'.$data->image) }}" id="img_setimage_pv_0" class="img-fluid"
                                                    style="margin:auto;" />
                                                <br /><br />
                                        ...
                                        <div class="col-md-7">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="type" id="type">
                                                            <option {{ isset($data->type)&&$data->type=='1'?'selected':'' }} value="1">Normal</option>
                                                            <option {{ isset($data->type)&&$data->type=='0'?'selected':'' }} value="2">SuperStar</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('description') is-invalid @enderror" name="description" required>{{ old('description', $data->description ?? '') }}</textarea>
                                            </div>
                                            <div class="form-group ">
                                                <label class="">Designation</label>
                                                <input type="text" class="form-control @error('designation') is-invalid @enderror" name="designation" value="{{ old('designation', $data->designation ?? '') }}" required>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="text-right pt-md-4 mt-2">
                                                        ...
                                                        <a style="width:100px;" href="{{ url('/admin/testimonials') }}"
                            ...
                            <div class="table-responsive">
                                <table id="dt-admin2" class="table table-striped table-bordered">
                                    ...
                                    <tbody id="getimageslist">
                                        @foreach (File::allfiles(public_path('uploads/Testimonial')) as $file)
                                            <tr>
                                                <td>
                                                    <label>
                                                        ...
                                                        <span style="display:inline-block"><img style="width:100px"
                                                                src="{{ asset('uploads/Testimonial/'.basename($file)) }}"
    ...
    <script>
        ...
        function setimagedb() {
            ...
            var urlimg = "{{ asset('uploads/Testimonial/') }}"+"/"+image;
