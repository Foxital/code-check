            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-2">
                        <div class="row">
                            <div class="col-md-10">
                                <h6 class="m-0 mt-2 font-weight-bold text-primary">Testimonial List</h6>
                            </div>
                            <div class="col-md-2 text-right">
                                <a href="{{ url('admin/testimonials/create') }}" class="btn btn-primary">Create Testimonial</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                ...
                columnDefs:[
                    ...
                    },
                    {
                        targets:2, render:function(data){
                            return data=='1'?'<span class="badge badge-success">Normal</span>':'<span class="badge badge-danger">SuperStar</span>';
                        }
                    },
                    {
