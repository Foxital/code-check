                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                              <div>
                                ...
                                <form id="adminuser" action="/admin/products/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="category_id" id="category_id" onchange="getCatg()" class="form-control" required>
                                                    ...
                                                    @foreach ($catgs as $catg)
                                                        <option {{ $data->category_id==$catg->id?'selected':'' }} value="{{ $catg->id }}">{{ $catg->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" onchange="linkcode()" id="link_code" class="form-control"
                                                    name="link_code" value="{{ $data->link_code }}" required>
                                            </div>
                                        </div>
                                        <div class="col-12 text-right">
                                            <button onclick="addmore()" type="button" class="btn btn-success btn-sm">Add Sizes</button>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row" id="getvalappendrow">
                                        @if(isset($data->ProductVarient))
                                            @foreach ($data->ProductVarient as $k=>$pv)
                                            <div class="col-12" id="rowid_{{ $k }}">
                                                <div class="row m-0">
                                                <div class="col-md-2">
                                                    <input type="hidden" value="{{ $pv->id }}" name="prid[]" />
                                                    <div class="form-group ">
                                                        <label class="">label</label>
                                                        <input type="text" class="form-control" onkeydown="labelchange(this)" name="label[]" value="{{ $pv->label }}" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" name="price[]" value="{{ $pv->price }}" required>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label class="">Discount</label>
                                                            <input type="text" class="form-control" name="discount[]" value="{{ $pv->discount }}" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" class="form-control" name="quantity[]" value="{{ $pv->quantity }}" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group ">
                                                        ...
                                                        <select class="form-control" name="pstatus[]" required>
                                                            <option {{ $pv->status=='1'?'selected':'' }} value="1">Active</option>
                                                            <option {{ $pv->status=='0'?'selected':'' }} value="0">Inactive</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-1 pt-4 text-center">
                                                    <button type="button" onclick="removeappend({{ $k }})" class="btn btn-danger btn-sm mt-2"><i class="fa fa-trash"></i></button>
                                                </div>
                                                </div></div>
                                            @endforeach
                                        @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group ">
                                                ...
                                                <textarea class="form-control summernote" name="how_to_use">{{ $data->how_to_use }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group setimage_pv text-center" style="{{ empty($data->image)?'display:none;':'' }}"
                                                id="setimage_pv_0">
                                                <input class="val_setimage_pv" id="val_setimage_pv_0" name="imagepv"
                                                    type="hidden" value="{{ $data->image }}" />
                                                <img src="{{ asset('uploads/Product/'.$data->image) }}" id="img_setimage_pv_0" class="img-fluid"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group setimage_pv text-center" style="{{ empty($data->image1)?'display:none;':'' }}"
                                                id="setimage_pv_1">
                                                <input class="val_setimage_pv" id="val_setimage_pv_1" name="image1pv"
                                                    type="hidden" value="{{ $data->image1 }}" />
                                                <img src="{{ asset('uploads/Product/'.$data->image1) }}" id="img_setimage_pv_1" class="img-fluid"
                                                    style="width: 150px;margin:auto;" />
                                                <br />
                                                <button class="btn btn-sm btn-danger" type="button"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group setimage" style="{{ !empty($data->image2)?'display:none;':'' }}" id="setimage_2">
                                            ...
                                            <div class="form-group setimage_pv text-center" style="{{ empty($data->image2)?'display:none;':'' }}"
                                                id="setimage_pv_2">
                                                <input class="val_setimage_pv" id="val_setimage_pv_2" name="image2pv"
                                                    type="hidden" value="{{ $data->image2 }}" />
                                                <img src="{{ asset('uploads/Product/'.$data->image2) }}" id="img_setimage_pv_2" class="img-fluid"
                                                    style="width: 150px;margin:auto;" />
                                                <br />
                                                <button class="btn btn-sm btn-danger" type="button"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group setimage" style="{{ !empty($data->image3)?'display:none;':'' }}" id="setimage_3">
                                            ...
                                            <div class="form-group setimage_pv text-center" style="{{ empty($data->image3)?'display:none;':'' }}"
                                                id="setimage_pv_3">
                                                <input class="val_setimage_pv" id="val_setimage_pv_3" name="image3pv"
                                                    type="hidden" value="{{ $data->image3 }}" />
                                                <img src="{{ asset('uploads/Product/'.$data->image3) }}" id="img_setimage_pv_3" class="img-fluid"
                                                    style="width: 150px;margin:auto;" />
                                                <br />
                                                <button class="btn btn-sm btn-danger" type="button"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="meta_title" value="{{ $data->meta_title }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Meta Description</label>
                                                <textarea type="text" class="form-control" name="meta_descp" required>{{ $data->meta_descp }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Meta Keyword</label>
                                                <input type="text" class="form-control" name="meta_keyword" value="{{ $data->meta_keyword }}" required>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table id="dt-admin2" class="table table-striped table-bordered">
                                    ...
                                    <tbody id="getimageslist">
                                        @foreach (File::allfiles(public_path('uploads/Product')) as $file)
                                            <tr>
                                                <td>
                                                    <label>
                                                        ...
                                                        <span style="display:inline-block"><img style="width:100px"
                                                                src="{{ asset('uploads/Product/' . basename($file)) }}"
